...
(function (ts) {
    ...
    function createSourceFile(filename, sourceText, languageVersion) {
        ...
        function tryParseParenthesizedArrowFunctionExpression() {
            ...
            if (triState === 1 /* True */) {
                var sig = parseSignature(120 /* CallSignature */, 42 /* ColonToken */);
                if (parseExpected(23 /* EqualsGreaterThanToken */)) {
        ...
        function parseBlock(ignoreMissingOpenBrace) {
        ...
        function parseModuleBody() {
            ...
            if (parseExpected(5 /* OpenBraceToken */)) {
                node.statements = parseList(1 /* ModuleElements */, parseModuleElement);
                parseExpected(6 /* CloseBraceToken */);
            }
            else {
                node.statements = createMissingList();
        ...
        function emitJavaScript(jsFilePath, root) {
            ...
            function emitDirectivePrologues(statements, startWithNewLine) {
                for (var i = 0; i < statements.length; ++i) {
                    if (statements[i].kind === 146 /* ExpressionStatement */ && statements[i].expression.kind === 3 /* StringLiteral */) {
